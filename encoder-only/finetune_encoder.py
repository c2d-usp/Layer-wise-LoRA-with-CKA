...
def main():
    ...
    if model_args.lora_layers is not None:
        lora_config_kwargs["layers_to_transform"] = one_hot_encoded_to_layer_index_list(model_args.lora_layers)
    
    if model_args.model_name_or_path != "roberta-base":
        lora_config_kwargs["target_modules"] = ["query_proj", "key_proj", "value_proj", "attention.output.dense", "intermediate.dense", "output.dense"]
